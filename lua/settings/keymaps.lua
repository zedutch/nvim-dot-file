...
-- Change height
vim.keymap.set("n", "K", "<cmd>resize +2<CR>")
vim.keymap.set("n", "J", "<cmd>resize -2<CR>")
-- Change width
vim.keymap.set("n", "H", "<cmd>vertical resize -2<CR>")
vim.keymap.set("n", "L", "<cmd>vertical resize +2<CR>")
